...
def camera_first(cam_id, capture):
    print("camera 1")
    ...
    if frame_captured:
        ...
        for marker in markers:
            ...
            if 315 < centerX < 550 and 30 < centerY < 330: # accel
                # keyboard.press('a')
                print("Excel")
                print(True)
            else:
...
if __name__ == '__main__':
	...
	while True:
		thread_1 = threading.Thread(target = camera_first, args=(cam_id, capture))
		...
		# 		# print(centerX, centerY);
		# 		print("camera2", centerX2, centerY2)
